...
public class MessageAuthReq implements Message, ReferenceCounted
{

    public static MessageAuthReq create()
    {
        return new MessageAuthReq();
    }

    private ByteBuf payload;

    private MessageAuthReq()
    {
    }
    ...
    @Override
    public MessageAuthReq setPayload(ByteBuf payload)
    {
